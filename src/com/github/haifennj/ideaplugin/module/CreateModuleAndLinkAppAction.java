...
import com.github.haifennj.ideaplugin.artifact.AWSArtifactRefresh;
import com.github.haifennj.ideaplugin.helper.NotificationUtil;
import com.github.haifennj.ideaplugin.helper.PluginUtil;
import com.github.haifennj.ideaplugin.link.LinkAppAction;
...
public class CreateModuleAndLinkAppAction extends LinkAppAction {
	...
	public void actionPerformed(AnActionEvent e) {
		...
		if (data != null) {
			...
			ArtifactManager artifactManager = ArtifactManager.getInstance(e.getProject());
			...
			if (message.length() > 0) {
				NotificationUtil.showInfoNotification(e, message.toString());
			}
		}
	}
